...
import 'package:try_auth_suba/page/create_cv/create_cv.dart';
import 'package:try_auth_suba/page/create_cv/update_cv.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        actions: [
          IconButton(
            icon: const Icon(Icons.all_inbox,size: 40,color: Colors.black),
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => const AllCv()));
            },
          ),
           IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => CVUpdateScreen()));
            },
          )
        ],
        title: FutureBuilder(
      ...
      floatingActionButton: IconButton(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => CVInsertScreen()));
          },
          icon: const Icon(
            Icons.add,
            color: Colors.black,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: EduWidget(
                                      jsonListEdu: jsonListEdu, edu: edu),
                                ),
                                const Divider(),
                                const SizedBox(height: 16),
                                const Text(
                                ...
                                SizedBox(
                                  width: MediaQuery.sizeOf(context).width * 0.8,
                                  child: expWidget(
                                      jsonListExp: jsonListExp, exp: exp),
                                ),
                                const Divider(),
                                const Text(
                                  'Project :',
                                ...
                                SizedBox(
                                  width: MediaQuery.sizeOf(context).width * 0.8,
                                  child: projectWidget(
                                      jsonListPro: jsonListPro, pro: pro),
                                ),
                                const Divider(),
                                const Text(
                                  'Reference :',
                                ...
                                SizedBox(
                                  width: MediaQuery.sizeOf(context).width * 0.8,
                                  child: refWidget(
                                      jsonListRef: jsonListRef, ref: ref),
                                ),
                                const Divider(),
                                const Text(
                                  'certification :',
                                ...
                                SizedBox(
                                  width: MediaQuery.sizeOf(context).width * 0.8,
                                  child: cerWidget(
                                      jsonListCer: jsonListCer, cer: cer),
                                ),
                                const Divider(),
                                const SizedBox(height: 16),
                                const Text(
